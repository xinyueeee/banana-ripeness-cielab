...
`requirements.txt`, `packages.txt` and `.streamlit/config.toml` are set up for a one-click
deploy: push this folder to GitHub, then at share.streamlit.io point the app at `app.py`.
